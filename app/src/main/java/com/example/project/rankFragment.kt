...
class rankFragment : Fragment() {
    ...
    private var dataholder:ArrayList<User>?=null
    ...
    override fun onCreateView(
        ...
        recyclerView=view.findViewById(R.id.recycelerViewRank)
        recyclerView!!.layoutManager=LinearLayoutManager(context)
        dataholder= ArrayList()
     //   val user:User=User(1,"yassine chihab","chihab")
        recyclerView!!.adapter=RankAdapter(dataholder!!)
        return view
    }
